const CORE_ASSEMBLER = [
    {
        ...
        temperature(x) {
            ...
            if (hasEvolutionTree(28, true)) y = y.pow(1.5)
            return y
        },
    },{
        color: ['#FFE400','#ffa500'],
        ...
        temperature(x) {
            ...
            if (hasEvolutionTree(29, true)) y = y.pow(1.5)
            return y.mul(x)
        },
    },{
        color: ['#fff','#00ffff'],
        ...
        temperature(x) {
            ...
            if (hasEvolutionTree(30, true)) y = y.pow(1.5)
            return y.mul(x)
        },
    },{
        color: ['#BFC8CD','#93a3ac'],
        ...
        temperature(x) {
            let t = this.base.root(hasEvolutionTree(31) ? 1.39 : 2.5).mul(x)
            if (hasEvolutionTree(31, true)) t = t.pow(1.5)
            return t
        },
    },
]
