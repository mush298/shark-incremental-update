const EVOLUTION_TREE = {
    ...
    charged_effect: [
        ()=>CURRENCIES.fish.total.max(0).add(10).log10().log10().add(1).log10().add(1).mul(simpleCETEffect(20)),
        ()=>CURRENCIES.prestige.total.max(0).add(10).log10().log10().add(1).log10().add(1).mul(simpleCETEffect(21)),
        ()=>CURRENCIES.core.total.max(0).add(10).log10().log10().div(20).add(1).pow(2).mul(simpleCETEffect(22)),
        ()=>E(10).pow(simpleCETEffect(23)),
        ...
        ()=>CURRENCIES.fish.total.max(0).add(10).log10().log10().div(60).add(1).log10().pow(4),
        ()=>CURRENCIES.prestige.total.max(0).add(10).log10().log10().div(45).add(1).log10().pow(4),
        ()=>CURRENCIES.core.total.max(0).add(1).log10().root(2).div(60).add(1).log10().pow(2),
        ()=>2,

        ()=>CURRENCIES.fish.total.max(0).add(10).log10().log10().div(2).log10().pow(2),
        ()=>CURRENCIES.stone.amount.max(0).add(1).log10().mul(5).log10().pow(2),
        ()=>CURRENCIES.humanoid.amount.log10().pow(2),
        ()=>1000,
...
function updateEvolutionTreeTemp() {
    ...
    if (hasResearch('a1')) tmp.total_faith = tmp.total_faith.mul(researchEffect('a1'))
