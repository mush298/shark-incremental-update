const FORGE = {
    ...
    matter: {
        ...
        time: [1e42,1e45,1e51,1e66,1e100, 1e180, 1e200, '1e369', '1e420'],
        cost: [
            [
                ['remnants',1e135],
                ['radium',100],
        ...
        effect(l) {
            let b = E(0.1)
            if (hasResearch('a2')) b = b.add(0.05)
            if (isSSObserved('pluto')) b = b.add(0.2)
            if (isSSObserved('sun')) b = b.add(0.25)
            var x = Decimal.mul(l,b).add(1)
