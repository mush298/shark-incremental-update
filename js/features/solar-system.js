...
const SPACEBASE_UPGS = {
    ...
    e6: {
        unl:()=>true,
        diff: 5,
        cost:a=>a.sumBase(1.05).pow_base(1e3).mul(1e40),
        bulk:a=>a.div(1e40).log(1e3).sumBase(1.05,true).add(1).floor(),
        res: "reserv",
        effect(a) {
            let x = a.add(1).pow(5)
            return x
    ...
    p1: {
        unl:()=>true,
        diff: 5,
        cost:a=>a.sumBase(1.05).pow_base(10).mul(1e100),
        bulk:a=>a.div(1e100).log(10).sumBase(1.05,true).add(1).floor(),
        res: "observ",
        effect(a) {
            let x = E(1).add(a.pow_base(1.5).log10().pow(2))
            return x
        },
        effDesc: x=>formatMult(x),
    },
    p2: {
        unl:()=>true,
        diff: 8,
        cost:a=>a.pow(2).pow10().pow10(),
        bulk:a=>a.log10().log10().root(2).floor(),
        res: "observ",
        effect(a) {
            let x = E(1).add(a.div(10))
            return x
        },
        effDesc: x=>formatMult(x),
    },
