const CURRENCIES = {
    ...
    observ: {
        ...
        get gain() {
            ...
            if (isSSObserved('neptune')) x = x.pow(10);

            x = expPow(x, spaceBaseUpgEffect('p2'))

            let o = E(0.76)

            if (hasResearch('o5')) o = o.add(0.14)
    ...
    reserv: {
        ...
        get gain() {
            ...
            if (hasResearch('o3')) x = x.pow(1.5)

            return x
        },
    
        get passive() { return hasResearch('o3') ? 1 : 0 },
    },
    traject: {
        get require() { return E(1e12) },
        ...
        get gain() {
            ...
            if (hasResearch('o4')) x = x.pow(1.5)

            return x
        },
    
        get passive() { return hasResearch('o4') ? 1 : 0 },
    },
}
